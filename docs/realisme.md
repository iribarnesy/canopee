...
| F. Dynamique des peuplements | 13 | 5 | 1 | 19 |
...
**Score de réalisme : 131 pleins + 20 partiels sur 153 → 92 %** *(un partiel compte 1/2)*.
...
| F18 | Un peuplement qu'on vient d'ouvrir (éclaircie, lisière neuve) verse pendant quelques années | 🟡 | `tempete.ts` (`memoireDAbri`, `naiveteAuVent`) ; `naivete-vent.test.ts` — **et le diagnostic qui justifiait le ❌ était faux, la mesure l'a montré.** Il disait que « les survivants sont réputés adaptés instantanément » : non, l'abri baisse dès la semaine qui suit la coupe. Ce qui manquait est l'ACCLIMATATION : chaque arbre retient l'abri sous lequel il a fabriqué son fût, et c'est la CHUTE entre cette mémoire et l'abri du jour qui le pénalise, sur les deux ruines à la fois. **Le résultat qu'on n'a pas écrit** : la naïveté distingue toute seule les deux façons d'éclaircir — 0,589 par le haut contre 0,012 par le bas — et s'estompe en cinq ans (0,486 → 0,062). **🟡 et pas ✅, et la raison a CHANGÉ en cours de route.** Elle était « une futaie ne s'abrite pas elle-même, donc les seuls arbres à avoir de l'abri à perdre sont trop courts pour verser » : c'est corrigé (#179), et l'ouverture dépouille désormais les dominants pour de bon — leur abri tombe de 0,115 à 0,021 après une éclaircie par le haut. Ce qui reste est plus profond : **dans ce moteur la HAUTEUR commande le risque de chablis** (profil logarithmique du vent, souplesse des jeunes tiges), si bien que toute opération qui déplace la distribution des hauteurs noie l'effet d'abri. Une éclaircie par le haut retire les grands, donc la population vulnérable : 8,3 % de ruines contre 43,7 % au témoin non éclairci. On ne sait donc pas isoler le surcroît dû à l'ouverture d'un peuplement dont on vient de retirer les arbres qui versent *(à faire : un banc à population appariée, ou une ouverture qui ne change pas la distribution des hauteurs — une lisière neuve plutôt qu'une éclaircie)* |
...
- **F19, l'amplification climatique** — c'est le plus important des trois,
  ...
  vent aussi.
- **F18, la fragilité d'après-éclaircie** — la mémoire par arbre existe (#177)
  et elle distingue l'éclaircie par le haut de celle par le bas. Ce qui reste
  a CHANGÉ : l'abri collectif est écrit (#179) et l'ouverture dépouille
  maintenant les dominants. Ce qui bloque est plus profond — **la hauteur
  commande le risque de chablis**, donc une éclaircie par le haut retire la
  population vulnérable en même temps qu'elle ouvre. Il faudra un banc à
  population appariée, ou une ouverture qui ne déplace pas les hauteurs : une
  lisière neuve plutôt qu'une éclaircie.
