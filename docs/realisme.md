...
| H15 | Un bois tué sur pied reste valorisable un temps, avec décote | ✅ | `DECOTE_CHABLIS`, `CHABLIS_RECUPERABLE_SEMAINES` ; qualité d'œuvre perdue. **Le nom ment encore** : ces deux constantes ne parlent aujourd'hui que du FEU, aucune tempête ne pouvant se lever (#55). Elles ne sont pas renommées pour autant — elles vaudront pour le chablis le jour où il existera |
